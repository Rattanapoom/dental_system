  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navigation">
      <ul class="navbar-nav">
        ...
        ?>
          <li class="nav-item">
            <a href="../Main/testsnew" class="nav-link" style="font-size : 20px; font-family: 'Prompt', sans-serif; "><i class="nc-icon nc-time-alarm"></i> จองคิว</a>
          </li>
          <li class="nav-item">
        ...
        ?>
          ...
          <li class="nav-item">
            <a href="../Main/Cus_booking" class="nav-link" style="font-size : 20px; font-family: 'Prompt', sans-serif; "><i class="nc-icon nc-time-alarm"></i> จองคิว</a>
          </li>
          <li class="nav-item">
