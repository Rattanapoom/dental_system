...
<body style="background-color: #013A6B;
  ...
  <div class="box3">
    ...
    foreach ($data as $row) {
    ?>
      <form method="post" action="../Main/backupnew">
        <div class="container">
          <tr>
            <td>

              <h1>นัดจองคิวทันตกรรมต่อ</h1>
            ...
            <th>
              <p>เวลาที่จอง</p>
              <input class="form-control" type="time" name="time" value="<?php echo $row->time; ?>" />
            </th><br>
            <th>
              <p>ชื่อแพทย์ </p>
            ...
            <select class="form-control" id="status" style="font-size : 17px; color: #000000;" name="status" hidden>
