...
class Menu_dental extends CI_Model
{
    ...
    function update_recordnew($date, $time, $idDental)
    {
        $query = $this->db->query("update dentalitems SET date='$date',time='$time' where idDental='$idDental'");
    }
